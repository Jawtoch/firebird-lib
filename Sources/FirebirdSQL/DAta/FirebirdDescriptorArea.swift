...
public struct FirebirdDescriptorArea {
	...
	public init(capacity count: Int16, version: Int16) {
	 ...
	 */
	public var parametersCount: ISC_SHORT {
		get {
			self.pointee.sqld
		}
		set {
	...
	public var variables: [FirebirdSQLVariable] {
...
extension FirebirdDescriptorArea: Sequence {
	...
	public func makeIterator() -> AnyIterator<FirebirdSQLVariable> {
		var index = 0
